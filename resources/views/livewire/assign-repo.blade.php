    ...
    <div class="bg-white p-3 relative">
        ...
        @else
            <div class="relative">
                ...
                @if($searchResults)
                    <div x-show="show" @click.outside="show = false" class="absolute max-h-64 overflow-y-auto z-20 top-[75%] left-0 bg-white z-10 rounded-md shadow-lg w-full overflow-hidden border border-gray-300">
